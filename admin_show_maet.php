...
?>
          <table class="table thai">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="admin_maet_data.php?ComID=<?php echo $record["id_meat_food"];?>">
                    <?php echo $record["name_meat_food"]; ?>
                  </a>
                </td>
                <td><?php echo $record["name_cook"]; ?></td>
                <td>
                  <a href="admin_edit_maet.php?ComID=<?php echo $record["id_meat_food"];?>">
                    <i class="fas fa-pencil-alt" style="font-size:18px" aria-hidden="true"></i>
                  </a>
                </td>
                <td>
                  <a href="admin_delete_maet.php?ComID=<?php echo $record["id_meat_food"];?>">
