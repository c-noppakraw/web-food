...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="collapse navbar-collapse thai">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="navbar-brand" href="show_maet.php">สูตรอาหาร</a>
      </li>
      <li class="nav-item">
...
?>
          <table class="table thai">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="maet_data.php?ComID=<?php echo $record["id_meat_food"];?>">
                    <?php echo $record["name_meat_food"]; ?>
                  </a>
                </td>
                <td><?php echo $record["name_cook"]; ?></td>
                <td>
                  <a href="edit_maet.php?ComID=<?php echo $record["id_meat_food"];?>">
                    <i class="fas fa-pencil-alt" style="font-size:18px" aria-hidden="true"></i>
                  </a>
                </td>
                <td>
                  <a href="delete_maet.php?ComID=<?php echo $record["id_meat_food"];?>">
      ...
      <div class="modal fade" id="Modalmauu">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form method="POST" action="add_maet.php">
                <div class="form-group">
                  <label>ชื่อเมนู :</label>
                  <input type="text" class="form-control col-md-10" id="name_meat_food" name="name_meat_food" placeholder="กรุณาใส่ ชื่อเมนู">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control col-md-10" id="meat_link" name="meat_link" placeholder="กรุณาใส่ ลิงค์วิดีโอ">
                </div>
                <div class="form-group">
