<?php
  ...
  $query = "SELECT * FROM sweets_food WHERE id_sweets_food = '".$_GET["ComID"]."' ";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="collapse navbar-collapse thai">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
          <a class="navbar-brand" href="Show_sweets.php">สูตรของหวาน</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="show_cocktail.php">สูตรเครื่องดื่ม</a>
      </li>
    </ul>
    ...
    <div class="container-fluid box">
      ...
      <div class="col-sm-12">
        <div class="box thai">
            <form method="POST" action="check_edit_sweets.php">
                <input type="hidden" value="<?php echo $_GET["ComID"] ?>" name="id_sweets_food">
                    <h4 class="text-center bg-warning text-dark">แก้ไขตำรา :</h4>
                    <div class="form-group">
                    <label>ลำดับ :</label>
                        <input type="text" class="form-control" id="id_sweets_food" name="id_sweets_food" value="<?php echo $id_sweets_food; ?>" disabled>
                    </div>
                    <div class="form-group">
                    <label>ชื่อเมนู :</label>
                        <input type="text" class="form-control" id="name_sweets_food" name="name_sweets_food" value="<?php echo $name_sweets_food; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <label>ลิงค์วิดีโอ :</label>
                        <input type="text" class="form-control" id="sweets_link" name="sweets_link" value="<?php echo $sweets_link; ?>">
                    </div>
