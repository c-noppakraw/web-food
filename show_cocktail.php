...
?>
          <table class="table thai">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="cocktail_data.php?ComID=<?php echo $record["id_cocktail"];?>">
                    <?php echo $record["name_cocktail"]; ?>
                  </a>
                </td>
                <td><?php echo $record["name_cook"]; ?></td>
                <td>
                  <a href="edit_cocktail.php?ComID=<?php echo $record["id_cocktail"];?>">
                    <i class="fas fa-pencil-alt" style="font-size:18px" aria-hidden="true"></i>
                  </a>
                </td>
                <td>
                  <a href="delete_cocktail.php?ComID=<?php echo $record["id_cocktail"];?>">
