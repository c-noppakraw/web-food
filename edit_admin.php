<?php
  ...
  $query = "SELECT * FROM admin WHERE id_admin = '".$_GET["ComID"]."' ";
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="collapse navbar-collapse thai">
    ...
    <div class="container-fluid box">
      ...
      <div class="col-sm-12">
        <div class="box thai">
            <form method="POST" action="check_edit_admin.php">
                <input type="hidden" value="<?php echo $_GET["ComID"] ?>" name="id_admin">
                    <h4 class="text-center bg-warning text-dark">แก้ไขผู้ดูแล :</h4>
                    <div class="form-group">
                    <label>ลำดับ :</label>
                        <input type="text" class="form-control" id="id_admin" name="id_admin" value="<?php echo $id_admin; ?>" disabled>
                    </div>
                    <div class="form-group">
                    <label>ชื่อผู้ใช้ :</label>
                        <input type="text" class="form-control" id="name_admin" name="name_admin" value="<?php echo $name_admin; ?>">
                    </div>
                    <div class="form-group">
                        <label>รหัสผ่าน :</label>
                        <input type="text" class="form-control" id="pass_admin" name="pass_admin" value="<?php echo $pass_admin; ?>">
                    </div>
