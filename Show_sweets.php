...
?>
          <table class="table thai">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="sweets_data.php?ComID=<?php echo $record["id_sweets_food"];?>">
                    <?php echo $record["name_sweets_food"]; ?>
                  </a>
                </td>
                <td><?php echo $record["name_cook"]; ?></td>
                <td>
                  <a href="edit_sweets.php?ComID=<?php echo $record["id_sweets_food"];?>">
                    <i class="fas fa-pencil-alt" style="font-size:18px" aria-hidden="true"></i>
                  </a>
                </td>
                <td>
                  <a href="delete_sweets.php?ComID=<?php echo $record["id_sweets_food"];?>">
