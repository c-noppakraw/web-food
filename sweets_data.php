...
<div class="container-fluid box">
      <div class="row">
        ...
        <div class="col-sm-8">
            <div class="thai box">
                <h2><?php echo $name_sweets_food; ?> <i class="fas fa-utensils text-warning"></i></h2>
                <div class="text-center"><br>
                    <iframe width="843" height="350" src="<?php echo $sweets_link; ?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe><br>
                </div><br>
                <h5><strong class="text-danger">ที่มา : </strong><?php echo $sweets_link; ?></h5>
            </div>
            <div class="thai box">
