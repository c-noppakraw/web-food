...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
  <div class="collapse navbar-collapse thai">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="navbar-brand" href="admin_show_cocktail.php">สูตรเครื่องดื่ม</a>
      </li>
    </ul>
...
?>
          <table class="table thai">
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <a href="admin_cocktail_data.php?ComID=<?php echo $record["id_cocktail"];?>">
                    <?php echo $record["name_cocktail"]; ?>
                  </a>
                </td>
                <td><?php echo $record["name_cook"]; ?></td>
                <td>
                  <a href="admin_edit_cocktail.php?ComID=<?php echo $record["id_cocktail"];?>">
                    <i class="fas fa-pencil-alt" style="font-size:18px" aria-hidden="true"></i>
                  </a>
                </td>
                <td>
                  <a href="admin_delete_cocktail.php?ComID=<?php echo $record["id_cocktail"];?>">
            ...
            <div class="modal-content">
              ...
              <form method="POST" action="add_cocktail.php">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control col-md-10" id="name_cocktail" name="name_cocktail" placeholder="กรุณาใส่ ชื่อเมนู">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control col-md-10" id="cocktail_link" name="cocktail_link" placeholder="กรุณาใส่ ลิงค์วิดีโอ">
                </div>
                <div class="form-group">
